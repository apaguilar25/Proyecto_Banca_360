    ...
    showConfirm({
      ...
      onConfirm: () => {
        ...
        showModal('Depósito acreditado', `
          <p class="transfer-success">¡Tu depósito fue acreditado con éxito!</p>
          <div class="modal-row"><span class="key">Cuenta</span><span class="val">Cuenta Ahorros · 0102-0123</span></div>
          <div class="modal-row"><span class="key">Monto</span><span class="val" id="val-positive">+${formatMoney(monto)}</span></div>
